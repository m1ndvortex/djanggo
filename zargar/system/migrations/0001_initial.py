    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['name'],
                'indexes': [models.Index(fields=['is_active', 'next_run_at'], name='system_back_is_acti_c8cf8a_idx'), models.Index(fields=['schedule_type'], name='system_back_schedul_a17780_idx'), models.Index(fields=['tenant_schema'], name='system_back_tenant__4eb251_idx')],
            },
        ),
        migrations.CreateModel(
            name='BackupRecord',
            ...
            options={
                ...
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['backup_type', 'status'], name='system_back_backup__2bea12_idx'), models.Index(fields=['tenant_schema'], name='system_back_tenant__1aa49f_idx'), models.Index(fields=['created_at'], name='system_back_created_2959e5_idx'), models.Index(fields=['expires_at'], name='system_back_expires_09de72_idx')],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('backup_record', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='integrity_checks', to='system.backuprecord', verbose_name='Backup Record')),
            ],
            options={
                ...
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['backup_record', 'status'], name='system_back_backup__fe79b2_idx'), models.Index(fields=['created_at'], name='system_back_created_8f1a80_idx')],
            },
        ),
    ]
